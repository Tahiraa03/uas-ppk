...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group row">
            <label for="a" class="col-sm-2 col-form-label">Nama Alternatif</label>
            <div class="col-sm-10">
                <select class="form-control" id="a" name="a">
                    ...
                    while ($row = mysqli_fetch_assoc($queryAlternatif)) {
                        ...
                        echo "<option value='" . $row['id_alternatif'] . "' $selected>" . $row['nm_alternatif'] . "</option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="col-sm-10">
                <select class="form-control" id="b" name="b">
                    ...
                    while ($row = mysqli_fetch_assoc($queryBobot)) {
                        ...
                        echo "<option value='" . $row['id_bobot'] . "' $selected>" . $row['nm_kriteria'] . "</option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="col-sm-10">
                <select class="form-control" id="s" name="s">
                    ...
                    while ($row = mysqli_fetch_assoc($querySkala)) {
                        ...
                        echo "<option value='" . $row['id_skala'] . "' $selected>" . $row['keterangan'] . "</option>";
                    }
                    ?>
                </select>
            </div>
